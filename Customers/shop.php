...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> This the available products, Shop now!</h3></center>
        </div>
...
while($query2=mysqli_fetch_array($query))
{
	...
	echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#02440f;'>
            <div class='panel-heading' style='color:white;background-color : #02440f;'>
            <center> 
...
if($id>1)
{
	echo "<li><a style='color:white;background-color : #02440f;' href='?id=".($id-1)."'>Previous Page</a><li>";
}
if($id!=$total)
{
	echo "<li><a style='color:white;background-color : #02440f;' href='?id=".($id+1)."' class='pager'>Next Page</a></li>";
}
echo "</ul>";
...
echo "<center><ul class='pagination pagination-lg'>";
		for($i=1;$i<=$total;$i++)
		{
			if($i==$id) { echo "<li class='pagination active'><a style='color:white;background-color : #02440f;'>".$i."</a></li>"; }
...
?>
			...
			<div class="alert alert-default" style="background-color:#02440f;">
                       ...
                       © 2022 PTC Merchandising | All Rights Reserved | Design by : K.I.R.V.
