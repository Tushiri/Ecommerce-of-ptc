...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Merchandising Platform</a>
            </div>
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <img src="../assets/img/pic1.jpg" alt="Hero Slide" style="width:100%;height:500px;">
        ...
        <div class="item">
            <img src="../assets/img/pic2.jpg" alt="..." style="width:100%;height:500px;">
        ...
        <div class="item">
            <img src="../assets/img/ptcbg.jpg" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/pic3.jpg" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/pic4.jpg" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/pic5.png" alt="..." style="width:100%;height:500px;">
...
<!-- #my-carousel-->
		...
		<br />	
			 <div class="alert alert-info" style="color:white;background-color:#02440f">
                        
                        &nbsp; &nbsp; Welcome to PTC Merchandising! So, if you're looking for your needs, why not visit the PTC Merchandising? 
						It's that easy. If you have a favorite Products & brands, 
						this is the easiest and most straightforward way to get it.A lot of Products & brands who are well known for one thing, 
						like shirts, also sell completes with 
						their own pants, along with other brands for things like jerseys, shoes, etc.
                    </div>
					<br />
			
			<div class="alert alert-default" style="background-color:#02440f;">
                       <p style="color:white;text-align:center;">
                       &copy 2022 PTC Merchandising | All Rights Reserved |  Design by : K.I.R.V.
